    ...
    <>
      ...
      {isLoading || isFetching ? (
        ...
        <>
          {data.success ? (
            <>
              <div className="relative bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% p-[1px] rounded-xl w-11/12 mx-auto mb-20 mt-5 overflow-scroll">
                <div className="min-w-[1300px]">
                  ...
                  <div className="relative flex gap-3 text-sm items-center px-4 py-2 bg-primaryBackground rounded-[12px_12px_0_0]">
                    <div className="w-full flex justify-between px-5 py-5 ">
                      ...
                      <p className="font-semibold min-w-[9%] max-w-[9%]">
                        Price
                      </p>
                      <p className="font-semibold min-w-[9%] max-w-[9%]">
                        1h %
                  ...
                  {data.info.data.map((item: CoinType) => {
                    return (
                      <div
                        ...
                        className="w-full bg-primaryBackground cursor-pointer px-5 py-4 border-t-[1px] border-secondaryText"
                      >
                  ...
                  <div className="w-full flex items-center justify-start bg-primaryBackground px-10 py-4 border-t-[1px] rounded-[0_0_12px_12px] border-secondaryText">
                    Page : {page}
                    <button
